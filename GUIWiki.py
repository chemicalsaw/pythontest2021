...
#ช่องค้นหาข้อมูล
v_search = StringVar()#กล่องสำหรับคีย์เวิร์ด
...
#ปุ่มค้นหา
def Search():
    keyword = v_search.get() #.get() คือ ดึงข้อมูลเข้า
    try:
...
B1.pack (ipadx=20,ipady=10) #ipadx ขยายในปุ่มแนวนแอน
